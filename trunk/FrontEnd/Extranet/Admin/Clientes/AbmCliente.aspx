												...
												<table cellSpacing="0" cellPadding="0" width="480" border="0">
													...
													<TR>
														<TD class="text" width="60%" colSpan="4">Razón Social
															<asp:requiredfieldvalidator id="reqRazonSocial" runat="server" ControlToValidate="txtRazonSocial" ErrorMessage="Ingrese Razón Social">*</asp:requiredfieldvalidator></TD>
													</TR>
													<TR>
