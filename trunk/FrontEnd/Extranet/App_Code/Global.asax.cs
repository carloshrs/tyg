...
namespace ar.com.TiempoyGestion.FrontEnd.Extranet 
{
	...
	public class Global : HttpApplication
	{
		...
		protected void Application_AuthenticateRequest(Object sender, EventArgs e)
		{
            ...
            if (strUrlKey.ToLower() != "default.aspx" && strUrlKey.ToLower() != "login.aspx" && strUrlKey.ToLower() != "loginextra.aspx" && strUrlKey.ToLower() != "recuperaclave.aspx" && strUrlKey.ToLower() != "nuevousuario.aspx" && strUrlKey.ToLower().EndsWith(".aspx"))
			{
				...
				if (authCookie != null)
				{
					...
					if (bolFlag && authTicket != null)
					{
						...
						//						}
						//
						if (authUser.IsInRole("Extranet") || authUser.CheckAccess(strUrlKey))
						{
