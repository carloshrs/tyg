...
namespace ar.com.TiempoyGestion.FrontEnd.Extranet.socioAmbiental
{
	...
	public partial class verInforme : Page
	{
		...
		private void LoadInforme(int Id)
		{
            ...
            if (oEncabezado.LogoEmpresa != "")
            {
                imgLogoEmpresa.ImageUrl = "/" + oEncabezado.LogoEmpresa;
                imgLogoEmpresa2.ImageUrl = "/" + oEncabezado.LogoEmpresa;
            }
            else
            {
                imgLogoEmpresa.ImageUrl = "/Img/shim.gif";
                imgLogoEmpresa2.ImageUrl = "/Img/shim.gif";
            }
