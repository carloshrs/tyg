...
(function ($) {
    ...
    var methods = {
        ...
        */
        ...
        alert("len: " + len + ", max: " + max);
        if (len > max) {
        var rule = options.allrules.maxSize;
        //alert(rule)
        //alert(rule.alertText)
        //alert(max)
        //alert(rule.alertText2)
        ...
        _maxSize: function (field, rules, i, options) {
            ...
            if (len > max) {
                var rule = options.allrules.maxSize;
                return "La longitud del texto debe ser menor a " + max;
                //return rule.alertText + max + rule.alertText2;
            }
        },
        /**
        ...
        */
        _minSize: function (field, rules, i, options) {
            ...
            if (len < min) {
                ...
                return "La longitud del texto debe ser mayor a " + min;
