...
<div class="cajaGeneral">
  <div class="topFlash">
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="867" height="238">
      ...
      <embed src="swf/03.swf" quality="high" wmode="opaque" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="867" height="238"></embed>
    </object>
  </div>
...
<div class="contenidoPrincipalInterno">
    <div class="contenidoInterno"><span class="titulo">NOVEDADES</span>
      <br>
    	<%
...
'			response.write Application("ConnectionString")
			...
			SQL = SQL & "FROM notas WHERE habilitado=1 AND idTipoNota=2 AND privado=0 "
			SQL = SQL & "ORDER BY orden"
            'response.write sql
            'response.end
			Set Articulos = oConn.execute(SQL)
		%>
      <p>			<% 
			i=0
			If Not Articulos.EOF Then
					While Not Articulos.EOF 
						Response.write "<h1 class=""tituloArticulo""><a href=""articulo.asp?idNota=" & Articulos("idNota") & """ class=""tituloArticulo"">" & Articulos("titulo") & "</a></h1>"
						Response.write Articulos("brief")
                        Response.write "<br />"
                        Response.write left(Articulos("fecha"),10) & " | <a href=""novedad.asp?idNota=" & Articulos("idNota") & """ class=""novedadesLink"">Ver más</a><br /><br />"
						Articulos.MoveNext
					Wend
				Else
					Response.Write("No hay artículos de interés")
				End If
			%>
 </p>
      <p>. </p>
