    ...
    <div>
      ...
      <div style="float:left; width:495px; height:336px; background-image: url(img/homemensajebajoder.jpg); background-repeat: no-repeat;">
        <div class="contenidoMensajeria">
          <ul>
            <li>              Traslados de llaves.</li>
            <li>Documentación notarial importe y relevante.</li>
            <li>Traslado de dinero, cheques u otros valores.</li>
            <li>Entrega de pasajes de viajes.</li>
            <li>Entrega de presentes empresariales.</li>
            <li>Entrega de liquidación de alquileres.</li>
            <li>Cobro de alquileres a domicilio.<br />
            <br />
            <br />
            <br />
            <br />
