...
'			response.write Application("ConnectionString")
			...
			SQL = "Select idNota, fecha, titulo, desarrollo "
			SQL = SQL & "FROM notas "
			SQL = SQL & "WHERE idNota = " & Request.QueryString("idNota")
            'response.write sql
            'response.end
      ...
      <p>						<% 
			...
			If Not Articulos.EOF Then
						Response.write "<h1 class=""tituloArticulo"">" & Articulos("titulo") & "</h1>"
						Response.write Articulos("desarrollo")
                        Response.write "<br /><br />"
                        Response.write "<i>Publicado el d&iacute;a " & left(Articulos("fecha"),10) & "</i>"
						Response.write "<br><br><div style=""text-align: center""><a href=""javascript:;"" onClick=""history.back()"" class=""linkEnviar"">Volver</a></div>"
				End If
			%>
 </p>
      <p>. </p>
