...
<div class="contenidoPrincipalInterno">
    <div class="contenidoInternoFull"><a href="servicios_desarrollo_software_outsourcing.asp" class="linkServicios"><span style="font-size:18px">Outsourcing</span> <br /></a>
      <p><img src="img/ico-outsourcing1.png" width="130" height="130" style="margin-top:7px; margin-left:10px;" align="right" />Este servicio está orientado a empresas que buscan externalizar parte de su producción subcontratando los servicios de diseño y programación Web. Su empresa podrá contar con nuestros recursos técnicos y humanos abaratando así sus costes de producción.</p>
<h5 style="font-size:14px;">Ventajas del Outsourcing Web:</h5>
      <ul>
        <li class="servicios"> Elimina costos de contratación de personal cualificado</li>
        <li class="servicios">          Elimina costos de formación</li>
        <li class="servicios">          Elimina costos de equipamiento</li>
        <li class="servicios">          Disminuye costos de gestión de proyectos</li>
        <li class="servicios">          Mejora la calidad</li>
      </ul>
      <br />
<br />
<br />
...
<br />
      ...
      <% =serviciosSoftAbajo("outsourcing") %>
    </div>
</div>
  </div>
  </div>
