<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Extranet.Informes.VerHistorialReferencias" CodeFile="VerHistorial.aspx.cs" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td width="100%" class="title">Histórico Acciones Referencias<BR>
						<HR>
						<BR>
					</td>
					<td width="2%" class="title">&nbsp;</td>
