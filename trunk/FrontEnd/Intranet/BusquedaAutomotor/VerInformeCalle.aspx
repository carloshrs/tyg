<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Extranet.BusquedaAutomotor.verInformeCalle" CodeFile="VerInformeCalle.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>Busqueda de Automotor</title>
...
width=175></td>
					<TD class="title" width="100%"><FONT color="#ffffff">
							<P align="center"><FONT color=gray>Búsqueda de 
      Automotor</FONT>
						</FONT></P></TD>
				</TR>
				<tr>
...
<asp:label id=lblObservaciones runat="server"></asp:label></TD></TR>
                    <TR>
                      <TD width="99%" 
                      ...
                      <TD width="100%" colSpan=4>
                        ...
                        width="100%" border=0>
                          <TR>
                            ...
                            colSpan=3 height=10>&nbsp;&nbsp; <FONT 
                              color=gray>Persona 
                        Jurídica</FONT></TD></TR></TABLE></TD></TR>
                    <TR>
...
<asp:label id=lblBarrio runat="server"></asp:label></TD></TR>
                    <TR>
													...
													<TR>
														<TD class="text" width="100%" colSpan="2">
															<asp:datagrid id="dgDominios" runat="server" AutoGenerateColumns="False" BackColor="White" BorderStyle="None"
																BorderColor="#CCCCCC" CellPadding="3" Font-Size="8pt" BorderWidth="1px" Width="100%" PageSize="5">
