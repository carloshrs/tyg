<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.BusquedaAutomotor.busautomotor_registro" CodeFile="busautomotor_registro.aspx.cs" %>
  ...
  <HEAD id="HEAD1" runat="server">
		...
		function cambiarEstado(id)
		{
		    if (confirm('¿Informe con problemas?')) {
		        window.showModalDialog('/BandejaEntrada/PopUpCambioEstado.aspx?idTipo=10&idInforme=' + id + '','','dialogWidth:400px;dialogHeight:250px');
		        document.location.href='/BandejaEntrada/Principal.aspx?idTipo=10';
		    } 
	        //return false;
		}
	...
	<body leftMargin="0" topMargin="0"> 
		...
		<uc1:menu id="Menu1" runat="server"></uc1:menu>
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
                ...
                <div style="margin-top:10px;">Búsqueda de automotor <b>En Espera</b> en codiciones para enviar al registro.</div>
                                    <asp:Panel ID="pnEnEspera" runat="server" style="margin-top:10px;margin-bottom:10px;">
                                        <br />
