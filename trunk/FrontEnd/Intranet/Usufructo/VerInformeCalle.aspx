<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Extranet.Usufructo.verInformeCalle" CodeFile="VerInformeCalle.aspx.cs" %>
...
width=175></td>
					<TD class="title" width="100%"><FONT color="#ffffff">
							<P align="center">
						</FONT><FONT color=gray>Informe de 
      Gravámenes - Usufructos </FONT></P></TD>
				</TR>
				<tr>
					<td colSpan="2">
