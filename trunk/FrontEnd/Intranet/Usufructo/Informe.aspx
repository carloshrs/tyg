<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Usufructo.Informe" CodeFile="Informe.aspx.cs" %>
				...
				<td>
					...
					<form id="Form1" method="post" runat="server">
						<TABLE cellSpacing="0" cellPadding="0" width="640" border="0">
							<tr>
								<td class="title" width="100%">Informe de Gravámenes - Usufructo</td>
							</tr>
							<tr>
								<td width="100%">
