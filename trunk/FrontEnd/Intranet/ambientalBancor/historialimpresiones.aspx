<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.ambientalBancor.historialimpresiones" CodeFile="historialimpresiones.aspx.cs" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td class="title" width="100%">
                        Historial de Informes Finalizados enviados a Bancor
						<BR>
						<HR>
						<BR>
                        <asp:Repeater ID="rpHistorial" runat="server">
                         ...
                         <div style="margin:16px;"><div style="float:left;"><img src="/Img/left.jpg" width="14" height="14" border="0" /></div>
                             <div style="width:700px; margin-top:5px;"><a href="importar.aspx?estado=-1&idGrupo=<%#Eval("id")%>" class="link">
