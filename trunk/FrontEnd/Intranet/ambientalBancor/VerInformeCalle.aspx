			...
			<TABLE class="tablaInforme" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="title" width="100%"><FONT color="#ffffff">
							<P align="center">
						</FONT><FONT color="gray">Entrevista de Relevamiento Habitacional</FONT></P></TD>
									...
									<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="title" width="100%" bgColor="lightgrey" colSpan="3" height="10">&nbsp;&nbsp;
												<FONT color="gray">Gestión sobre la verificación</FONT></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
								...
								<TD class="text" width="100%" colSpan="4">
									<TABLE class="text" style="BORDER-COLLAPSE: collapse" borderColor="#111111" cellSpacing="0"
										...
										<TR>
											...
											<TD class="text" width="250"><STRONG>E-mail:</STRONG>
												<BR>
								...
								<TD class="text" width="100%" colSpan="4">
									<TABLE class="text" style="BORDER-COLLAPSE: collapse" borderColor="#111111" cellSpacing="0"
										...
										<TR>
											...
											<TD height="14" vAlign="top"><STRONG>Destino del inmueble:</STRONG>
												<BR>
												<asp:Label id="lblDestino" runat="server"></asp:Label></TD>
											<TD width="33%" colSpan="2" vAlign="top"><STRONG>Tipo de construcción:</STRONG>
												<BR>
										...
										<TR>
											...
											<TD width="33%" vAlign="top"><STRONG>Estado de conservación:</STRONG>
												<BR>
										...
										<TR>
											<TD class="text" width="50%" colspan="2"><STRONG>Informó:&nbsp;</STRONG><BR>
												<asp:label id="lblInformo" runat="server"></asp:label></TD>
											<TD class="text" width="50%"><STRONG>Relación:&nbsp;</STRONG><BR>
