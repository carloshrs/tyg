...
<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Contratos.Historial" CodeFile="Historial.aspx.cs" %>
														...
														<asp:TemplateColumn>
															...
															<ItemTemplate>
																<asp:ImageButton id="Editar" runat="server" Width="16px" ImageUrl="/img/modificar_general.gif" CommandName="Editar"
																	ToolTip="Editar Histórico"></asp:ImageButton>
															</ItemTemplate>
														</asp:TemplateColumn>
														<asp:TemplateColumn>
															<HeaderStyle Width="10px"></HeaderStyle>
															...
															<ItemTemplate>
																<asp:ImageButton id="Cancelar" runat="server" Width="16px" ImageUrl="\Img\Cruz.gif" CommandName="Cancelar"
																	ToolTip="Eliminar Histórico"></asp:ImageButton>
															</ItemTemplate>
														</asp:TemplateColumn>
													</Columns>
										...
										<tr>
											<td align="right">
												<table cellSpacing="0" cellPadding="0" width="25%" border="0">
													<tr>
														<td><asp:button id="btnInforme" runat="server" Width="155px" Text="Nuevo Registro" onclick="btnInforme_Click"></asp:button></td>
														<td><input id="Cancelar" onclick="javascript:window.location.href='ListaContratos.aspx';" type="button"
																size="20" value="  Cerrar  "></td>
													</tr>
												</table>
											</td>
										</tr>
