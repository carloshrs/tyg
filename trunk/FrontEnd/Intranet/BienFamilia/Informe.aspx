<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.BienFamilia.Informe" CodeFile="Informe.aspx.cs" %>
				...
				<td>
					...
					<form id="Form1" method="post" runat="server">
						<TABLE cellSpacing="0" cellPadding="0" width="640" border="0">
							<tr>
								<td class="title" width="100%">Informe de Gravámenes - Bien de Familia</td>
							</tr>
							<tr>
								<td width="100%">
															...
															<TABLE cellSpacing="0" cellPadding="0" width="624" border="0">
																...
																<TR>
																	<TD class="text" width="33%">Folio&nbsp;
																		<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtFolio"></asp:RequiredFieldValidator></TD>
																	<TD class="text" width="33%">Tomo&nbsp;
																		<asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="txtTomo"></asp:RequiredFieldValidator></TD>
																	<TD class="text" width="33%">Año&nbsp;
																		<asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="txtAno"></asp:RequiredFieldValidator></TD>
																</TR>
																<TR>
												...
												<table cellSpacing="0" cellPadding="0" width="624" border="0" height="24">
													<TR>
														<TD class="text" align="right">
															...
															<asp:button id="AceptarFinalizar" runat="server" Width="108px" Text="Aceptar y Finalizar" onclick="AceptarFinalizar_Click"></asp:button>&nbsp;&nbsp;
