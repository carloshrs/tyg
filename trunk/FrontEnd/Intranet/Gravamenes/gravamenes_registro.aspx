<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.BandejaEntrada.gravamenes_registro" CodeFile="gravamenes_registro.aspx.cs" %>
	...
	<body leftMargin="0" topMargin="0"> 
		...
		<uc1:menu id="Menu1" runat="server"></uc1:menu>
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
                ...
                <div style="margin-top:10px;">Informes de gravámenes <b>En Espera</b> en codiciones para generar el formulario de taza.</div>
                                    <asp:Panel ID="pnEnEsperaSUrgentes" runat="server" style="margin-top:10px;margin-bottom:10px;">
