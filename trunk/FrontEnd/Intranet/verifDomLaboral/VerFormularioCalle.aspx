<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.VerifDomLaboral.VerFormularioCalle" CodeFile="VerFormularioCalle.aspx.cs" %>
													...
													<TR>
														<TD width="100%" colSpan="4">
															<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<TR>
																	<TD class="title" width="100%" bgColor="#d3d3d3" colSpan="3" height="10">&nbsp;&nbsp; <FONT 
