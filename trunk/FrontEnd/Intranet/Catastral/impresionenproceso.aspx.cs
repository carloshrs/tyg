...
public partial class InformeInhibicion_listadopendientes : System.Web.UI.Page
{
    ...
    private void listarInformesInhibicionEnProceso()
    {
        ...
        dlUrgente.DataSource = bandeja.ListaEncabezadosGrupos(-1, -1, 12, estado, 2, FechaDesde, FechaHasta, 0, false, intGrupo, "");
        dlUrgente.DataBind();

        dlNormal.DataSource = bandeja.ListaEncabezadosGrupos(-1, -1, 12, estado, 1, FechaDesde, FechaHasta, 0, false, intGrupo, "");
        dlNormal.DataBind();
