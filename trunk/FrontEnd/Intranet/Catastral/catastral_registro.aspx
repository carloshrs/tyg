<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Catastral.catastral_registro" CodeFile="catastral_registro.aspx.cs" %>
  ...
  <HEAD id="HEAD1" runat="server">
		...
		function cambiarEstado(id)
		{
		    if (confirm('¿Informe con problemas?')) {
		        window.showModalDialog('/BandejaEntrada/PopUpCambioEstado.aspx?idTipo=12&idInforme=' + id + '','','dialogWidth:400px;dialogHeight:250px');
		        document.location.href='/BandejaEntrada/Principal.aspx?idTipo=12';
		    } 
	        //return false;
		}
	...
	<body leftMargin="0" topMargin="0"> 
		...
		<uc1:menu id="Menu1" runat="server"></uc1:menu>
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
                ...
                <div style="margin-top:10px;">Informe catastral <b>En Espera</b> en codiciones para generar el formulario de taza.</div>
