<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Automotores.automotor_registro" CodeFile="automotor_registro.aspx.cs" %>
	...
	<body leftMargin="0" topMargin="0"> <!--  onload="javascript:mostrarFiltro(true, '');"-->
		...
		<FORM id="Tipos" method="post" runat="server">
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
                ...
                <div style="margin-top:10px;">Informe de automotor <b>En Espera</b> en codiciones para enviar al registro.</div>
