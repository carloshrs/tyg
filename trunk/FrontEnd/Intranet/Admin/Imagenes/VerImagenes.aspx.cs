...
namespace ar.com.TiempoyGestion.FrontEnd.Intranet.Admin.Imagenes
{
	...
	public partial class VerImagenes : Page
	{
		...
		private void dgImagenes_PreRender(object sender, EventArgs e)
		{
			...
			{
				((ImageButton)myItem.FindControl("ibutVer")).Attributes.Add("onClick","Javascript:Mostrar('/Admin/Imagenes/VerImagen.aspx?path=" + myItem.Cells[4].Text + "&desc=" + myItem.Cells[1].Text + "');return false;");
