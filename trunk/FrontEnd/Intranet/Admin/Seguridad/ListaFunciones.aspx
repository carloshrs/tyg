...
<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Admin.Seguridad.Admin.Seguridad.ListaFunciones" CodeFile="ListaFunciones.aspx.cs" %>
				...
				<tr>
					...
					<td class="text" height="38">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="title" height="38">&nbsp; <STRONG>Listado de Funciones</STRONG>
									<HR>
									<BR>
								</td>
							</tr>
							<tr>
								<td>
									<asp:datagrid id="dgFunciones" runat="server" Font-Size="8pt" PageSize="20" CellPadding="3" BorderColor="#3657A6"
										...
										<Columns>
											<asp:BoundColumn Visible="False" DataField="IdFuncion">
											...
											<asp:BoundColumn DataField="UrlKey" HeaderText="URL Key">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											<asp:TemplateColumn>
							...
							<tr>
								<td class="text" height="38" align="right">
									<asp:Button id="btnNuevaFuncion" runat="server" Text="Agregar Nuevo" onclick="btnNuevaFuncion_Click"></asp:Button>
								</td>
							</tr>
						</table>
					</td>
