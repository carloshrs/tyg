<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Admin.Cuentas.mensualesmasivos" CodeFile="listadoDocumentosMasivo.aspx.cs" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td class="title" width="100%">
                        Recibos mensuales por clientes (masivos)
						<BR>
						<HR>
						<BR>
                        <asp:Repeater ID="rpHistorial" runat="server">
                         ...
                         <div style="margin:16px;"><div style="float:left;"><img src="/Img/left.jpg" width="14" height="14" border="0" /></div>
                             ...
                             <a href="VerMovimiento.aspx?idTipo=<%#Eval("idTipo")%>&nroMovimiento=<%#Eval("nroMovimiento")%>&idCliente=<%#Eval("idCliente")%>" class="link">&nbsp;
                               <%#Eval("cliente")%> (total <%#Eval("total")%>)
                              </a></div>
                              </div>
                         </ItemTemplate>
                        </asp:Repeater>
