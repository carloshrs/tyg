<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Admin.Cuentas.mensualesmasivos" CodeFile="listadoGruposDocumentosMasivo.aspx.cs" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td class="title" width="100%">
                        Recibos mensuales generados automaticamente (masivos)
						<BR>
						<HR>
						<BR>
