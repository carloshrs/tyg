<%@ Page language="c#" AutoEventWireup="true" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Admin.Cuentas.Admin_Cuentas_remitos" CodeFile="VerRemitos.aspx.cs" %>
...
function iPrint() {
    if (document.getElementById("chkImprimirDetalle").checked) {
        //__doPostBack('ButtonCorda1', GraphNumber);
        window.idImprimirDetalleRef.focus();
        window.idImprimirDetalleRef.print();
    }
    else {
        window.idImprimirDetalle.focus();
        window.idImprimirDetalle.print();
						...
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="title" height="38">
                                    <asp:Label ID="lblDocumento" runat="server" Text=""></asp:Label> Nº <asp:Label ID="lblNroRemito" runat="server"></asp:Label>
									<HR>
									<BR>
								</td>
							</tr>
