<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Extranet.EstadoCivil.ListaEstadoCivil" CodeFile="abmlEstadoCivil.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Listado de estado civil</title>
						...
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="text" height="38">&nbsp;<BR>
									<STRONG>Listado de estados civiles</STRONG>
								</td>
							</tr>
							<tr>
								<td><asp:datagrid id="dgEstadoCivil" runat="server" Width="100%" AutoGenerateColumns="False" GridLines="Vertical"
										...
										<Columns>
											<asp:BoundColumn Visible="False" DataField="idEstadoCivil" HeaderText="id">
							...
							<tr>
								<td class="text" height="38">
									<TABLE cellSpacing="3" cellPadding="1" width="100%" border="1" bordercolor="#3657a6" style="BORDER-COLLAPSE:collapse"
										...
										<TR>
											<TD>
												<asp:Label id="lblEstado" runat="server" Font-Bold="True">Alta de estado civil</asp:Label><BR>
												&nbsp;<BR>
												Descripción:
												<asp:textbox id="TxtEstadoCivil" runat="server" Width="207px" CssClass="planotext"></asp:textbox>&nbsp;&nbsp;&nbsp;
												<asp:button id="btnAceptar" runat="server" Width="80px" Text="Aceptar"></asp:button>&nbsp;
												<asp:button id="btnCancelar" runat="server" Width="80px" Text="Cancelar" CausesValidation="False"></asp:button><INPUT id="hidEstadoCivil" type="hidden" runat="server" size="1" NAME="hidEstadoCivil">
											</TD>
										</TR>
									</TABLE>
								</td>
							...
							<tr>
								<td>
									<P align="center"><BR>
										<asp:RequiredFieldValidator id="valDescripcion" runat="server" CssClass="text" ControlToValidate="TxtEstadoCivil"
