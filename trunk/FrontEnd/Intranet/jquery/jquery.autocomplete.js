...
$.Autocompleter = function(input, options) {
	...
	function selectCurrent() {
        ...
        //alert(valor.split(",")[2]);
        $("#hdIdCliente").val(valor.split(",")[0]); // SETEA EL ClienteID al campo hdIdCliente, array [0]
        //$("#txtDireccion").text(valor.split(",")[2]);
        //alert(selected.data);
		$input.trigger("result", [selected.data, selected.value]);
        //__doPostBack('','');
        seleccionarCliente(valor.split(",")[0]);
		return true;
	}

    function seleccionarCliente2(idCliente){
        //alert("idCliente: " + idCliente);
        $.ajax({
          cache: false, 
           type: "POST",      
          url:"altaInforme.aspx/SelectCliente",
          contentType: "application/json;charset=utf-8",
          data: 
            //Cambio: $("#txtEditName").val(),
            "{'IdCliente': " + idCliente + "}"
          ,
          success: function() {
