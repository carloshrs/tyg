<%@ Page Language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.InformePropiedadOtrasProvincias.Informe"
    ...
    <script>
		...
		function mostrarFiltro(name)
		{
			...
			function ChequearMatricula()
			{
				...
				vTipoInforme = 11;
				vProvincia = document.forms[0].cmbProvincia.value;
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr>
                            <td class="title" width="100%">
                                Solicitud de Informe de propiedad de otras provincias<br>
                            </td>
                        </tr>
<tr>
					    <td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                            ...
                                                            <tr>
                                                                <td class="text" width="175" colspan="4">
                                                                    <asp:Label ID="lblTipoPropiedad" runat="server" Font-Bold="True">Nro de Inscripción</asp:Label>&nbsp;
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="Ingrese el nro de inscripción"
                                                        ...
                                                        <asp:Panel ID="pnPlanilla" runat="server">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text" width="50%" colspan="2">
                                                                    <asp:Label ID="Label4" runat="server">Departamento</asp:Label>&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text" width="270" colspan="2">
                                                                    <asp:TextBox ID="txtPedania" runat="server" MaxLength="255" Width="215px"></asp:TextBox></td>
                                                                <td class="text" width="50%" colspan="2">
                                                                    <asp:TextBox ID="txtDepartamento" runat="server" MaxLength="255" Width="215px"></asp:TextBox>
                                                                    </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td class="text" width="270" colspan="2" height="4">
                                                                    <asp:Label ID="Label2" runat="server">Provincia</asp:Label>&nbsp;</td>
                                                                <td class="text" width="50%" colspan="2" height="4">
                                                                    <asp:Label ID="Label8" runat="server">Localidad</asp:Label>&nbsp;</td>
                                                            </tr>
                                                            <tr>
