...
namespace ar.com.TiempoyGestion.FrontEnd.Intranet.InformePropiedadProvincias
{
    /// <summary>
    ...
    public partial class historialimpresiones : Page
    {
        ...
        private void ListarHistorial(int idTipo)
        {
            ...
            {
                lblMensaje.Text = "No hay historial de Informes de Propiedad de otras provincias.";
