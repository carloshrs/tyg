...
namespace ar.com.TiempoyGestion.FrontEnd.Intranet.BandejaEntrada
{
    ...
    /// </summary>
    public partial class busquedapropiedad_registro : Page
    {
        private int IdTipo;
        ...
        private void ListaBandeja(int idTab)
        {
            ...
            {
                lblMensaje.Text = "No hay Búsqueda de Propiedad para generar el formulario taza.";
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (dgridEnEsperaUrgentes.Items.Count > 0 || dgridEnEsperaNormales.Items.Count > 0)
                intGrupo = Encabezado.crearGrupoCambioEstado(Usuario.IdUsuario, 13);
        ...
        private void ListaBandejaFiltro()
        {
            ...
            if ((dgridEnEsperaUrgentes.Items.Count == 0) && (dgridEnEsperaNormales.Items.Count == 0))
            {
                lblMensaje.Text = "No hay Búsquedas de Propiedad para generar el formulario taza.";
                lblMensaje.Visible = true;
                //btnImprimir.Visible = false;
            }
        ...
        {
            Response.Redirect("historialimpresiones.aspx?idTipo=13");
        }
}
}