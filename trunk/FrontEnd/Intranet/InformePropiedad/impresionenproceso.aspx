<%@ Page Language="C#" AutoEventWireup="true" CodeFile="impresionenproceso.aspx.cs" Inherits="InformePropiedad_listadopendientes" %>
...
<body onload="imprimir();">
    ...
    <div>
        ...
        <asp:DataList ID="dlUrgente" runat="server" ShowFooter="False" ShowHeader="False"  style="float:left; width:100%;" RepeatColumns="2">
            <ItemTemplate>
                <asp:Panel ID="pnUrgente" runat="server" style="width:100%; float:left; margin:0px; padding:0px;">
                        <div style="width:100%; float:left;">
                        Cliente:
                        <asp:Label ID="lblCliente" runat="server" Text='<%# Eval("Cliente")%>' Font-Bold="true"></asp:Label> - <asp:Label ID="lblUsuario" runat="server" Text='<%# Eval("UsuarioCliente")%>' Font-Bold="true"></asp:Label>
                        <asp:Label ID="lblRow" runat="server" Text='<%# Eval("row_no") %>' Visible="false"></asp:Label>
        ...
        <asp:DataList ID="dlNormal" runat="server" ShowFooter="False" ShowHeader="False"  style="float:left; width:100%;" RepeatColumns="2">
            <ItemTemplate>
                <asp:Panel ID="pnNormal" runat="server" style="width:100%; float:left; margin:0px; padding:0px;">
                    <div style="width:100%; float:left;">
                        Cliente:
                        <asp:Label ID="lblCliente" runat="server" Text='<%# Eval("Cliente")%>' Font-Bold="true"></asp:Label> - <asp:Label ID="lblUsuario" runat="server" Text='<%# Eval("UsuarioCliente")%>' Font-Bold="true"></asp:Label>
                        <asp:Label ID="lblRow" runat="server" Text='<%# Eval("row_no") %>' Visible="false"></asp:Label>
