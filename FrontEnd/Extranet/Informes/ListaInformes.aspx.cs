            ...
            foreach (DataGridItem myItem in dgridEncabezados.Items)
            {
                ...
                if (myItem.Cells[10].Text == "3")
                {
                    ...
                    if (strRedir != "" && (blObtenerClienteMensual || blHabilitarFinalizados || blInformePagado))
                    {
                        ...
                        if ((myItem.Cells[12].Text == "1" || myItem.Cells[12].Text == "16"  || myItem.Cells[12].Text == "17") && myItem.Cells[10].Text == "3" && (DateTime.Parse(myItem.Cells[1].Text) >= FechaLimite) && myItem.Cells[16].Text != "&nbsp;")
                        {
