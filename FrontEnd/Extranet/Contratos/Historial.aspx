<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Extranet.Contratos.Historial" CodeFile="Historial.aspx.cs" %>
											...
											<td align="right">
												<table cellSpacing="0" cellPadding="0" width="25%" border="0">
													<tr>
														...
														<td><input id="Cancelar" onclick="javascript:window.location.href='ListaContratos.aspx';" type="button" size="" value="  Cerrar  "></td>
													</tr>
												</table>
											</td>
										</tr>
