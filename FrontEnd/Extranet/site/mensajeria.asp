  ...
  <div>
    ...
    <div>
      ...
      <div style="float:left; width:495px; height:336px; background-image: url(img/homemensajebajoder.jpg); background-repeat: no-repeat;">
        <div class="contenidoMensajeria"><span class="tituloMensajeria"><br />
          llegamos...</span><br />
          <br />
          ... al lugar indicado en el momento justo. Innovamos, incorporamos servicios no tradicionales y vamos más allá. Vamos a donde mas dificil resulta llegar: a un cliente 100% satisfecho. Ese es nuestro compromiso.<br />
          <br />
          <br />
          <br />
<br />
          <br />
          <span class="pieMensajeria">Eficacia, privacidad y seguridad</span>
        </div>
      </div>
    </div>
    <br />
