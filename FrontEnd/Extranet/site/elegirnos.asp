...
<div class="contenidoPrincipalInterno">
    <div class="contenidoInterno"><span class="titulo">PORQUE ELEGIRNOS</span>
      <br>
      <p> <strong>Nuestro desempeño</strong><br />
        <br />
Para analizar la eficiencia de una empresa, es necesario tener en   cuenta algunos puntos importantes que determinaran la excelencia de sus   servicios y la confiabilidad del mismo.</p>
      <p>Es inevitable evaluar el desempeño de   una organización a la hora de contratar sus servicios e imprescindible   comparar:<br />
        <strong><br />
          1</strong>. el profesionalismo con el   que se desarrolla el trabajo<br />
  <strong>2</strong>. la excelencia y el   respeto con el que será tratado cada cliente<br />
  <strong>3</strong>. la eficiencia y   eficacia que demostraran nuestros informes<br />
  <strong>4</strong>. el costo, teniendo   en cuanta la relación costo beneficio<br />
  <strong>5</strong>. la velocidad de respuesta ante una necesidad</p>
      <p><strong>Tiempo &amp; Gestión</strong> proporciona   anualmente mas de 60.000 informes, cifra elocuente de por si, esto le permite afirmar que cuenta con una   								base de datos en permanente actualización para   								llevar el control que hace falta sobre las   								garantías conocidas como “presta firma”. </p><br />
