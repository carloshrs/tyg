<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.InformePropiedadOtrasProvincias.verInforme" CodeFile="VerInforme.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>Informe de Propiedad otras Provincias</title>
										...
										<TR>
											<TD class="text" width="50%">
												<TABLE id="Table3" style="BORDER-COLLAPSE: collapse" borderColor="#000000" cellSpacing="0"
													...
													<TR>
														<TD class="text" width="50%" colSpan="2"><asp:label id="lblTipoPropiedad" runat="server" Font-Bold="True">
                                                            Nº de Inscripción</asp:label>:&nbsp;
															<asp:label id="lblMatricula" runat="server"></asp:label></TD>
															<TD class="text" width="50%" colSpan="2"><asp:label id="Label10" runat="server" Font-Bold="True">
                                                            Provincia</asp:label>:&nbsp;
															<asp:label id="lblProvinciaTop" runat="server" Font-Bold="true"></asp:label></TD>
													</TR>
