...
namespace ar.com.TiempoyGestion.FrontEnd.Intranet.BusquedaAutomotor
{
    ...
    /// </summary>
    public partial class busautomotor_registro : Page
    {
        private int IdTipo;
        ...
        private void ListaBandeja(int idTab)
        {
            ...
            if (dgridEnEspera.Items.Count == 0)
            {
                lblMensaje.Text = "No hay Búsquedas de Automotor para enviar al registro del automotor.";
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (dgridEnEspera.Items.Count > 0)
                intGrupo = Encabezado.crearGrupoCambioEstado(Usuario.IdUsuario, 10);
        ...
        {
            Response.Redirect("historialimpresiones.aspx?idTipo=10");
        }
}
}