<%@ Page Language="C#" AutoEventWireup="true" CodeFile="impresionenproceso.aspx.cs" Inherits="BusquedaAutomotor_impresionenproceso" %>
...
<body onload="imprimir();">
    ...
    <div>
        ...
        <div style="width:100%; float:left; margin-bottom:20px; font-weight:bold; text-align:center; font-size:16px;">LISTADO DE BÚSQUEDA DE AUTOMOTOR</div>
