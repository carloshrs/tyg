<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Extranet.Contratos.AltaPersonas" CodeFile="AltaPersonas.aspx.cs" %>
	...
	<body leftMargin="0" topMargin="0">
		...
		<FORM id="Tipos" method="post" runat="server">
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<TD width="2%">&nbsp;</TD>
					<td class="title" width="100%">Alta&nbsp;de Personas<BR>
						<HR>
						<BR>
					</td>
				</tr>
										...
										<TR>
											<TD class="text" width="100%"><asp:panel id="pnlPersona" runat="server">
													<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
														...
														<TR>
															<TD class="text" width="535" colSpan="4"><asp:textbox onKeyPress="return validarString(event);" id="Apellido" runat="server" Width="100%" MaxLength="255"></asp:textbox></TD>
														</TR>
														<TR>
														...
														<TR>
															...
															<TD class="text" align="left" width="235" colSpan="2">&nbsp;&nbsp; <IMG height="1" src="/img/shim.gif" width="20"><asp:textbox onKeyPress="return validarString(event);" id="Documento" runat="server" Width="150px" MaxLength="45"></asp:textbox></TD>
														</TR>
													</TABLE></TD>
										</TR>
										<TR>
													...
													<TR>
														<TD width="536" colSpan="4">
															<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
																...
																<TR>
																	<TD class="text" width="70%"><asp:textbox onKeyPress="return validarString(event);" id="Calle" runat="server" Width="320px" MaxLength="255"></asp:textbox></TD>
																	<TD class="text" width="10%"><asp:textbox onKeyPress="return validarString(event);" id="Nro" runat="server" Width="46px" MaxLength="20"></asp:textbox></TD>
																	<TD class="text" width="10%"><asp:textbox onKeyPress="return validarString(event);" id="Dpto" runat="server" Width="46px" MaxLength="20"></asp:textbox></TD>
																	<TD class="text" width="10%"><asp:textbox onKeyPress="return validarString(event);" id="Piso" runat="server" Width="47px" MaxLength="20"></asp:textbox></TD>
																</TR>
															</TABLE>
														</TD>
													</TR>
