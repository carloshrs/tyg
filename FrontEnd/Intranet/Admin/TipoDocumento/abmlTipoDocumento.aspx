<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Extranet.TipoDocumento.ListaTipoDocumento" CodeFile="abmlTipoDocumento.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Listado de tipos de documentos</title>
						...
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="text" height="38">&nbsp;<BR>
									<STRONG>Listado de tipos de&nbsp;documentos</STRONG>
								</td>
							</tr>
							<tr>
								<td><asp:datagrid id="dgTipoDocumento" runat="server" Width="100%" AutoGenerateColumns="False" GridLines="Vertical"
										...
										<Columns>
											<asp:BoundColumn Visible="False" DataField="idTipoDocumento" HeaderText="id">
							...
							<tr>
								<td class="text" height="38">
									<TABLE cellSpacing="3" cellPadding="1" width="100%" border="1" bordercolor="#3657a6" style="BORDER-COLLAPSE:collapse"
										...
										<TR>
											<TD>
												<asp:Label id="lblEstado" runat="server" Font-Bold="True">Alta de tipo de documento</asp:Label><BR>
												&nbsp;<BR>
												Descripción:
												<asp:textbox id="TxtTipoDocumento" runat="server" Width="207px" CssClass="planotext"></asp:textbox>&nbsp;&nbsp;&nbsp;
												<asp:button id="btnAceptar" runat="server" Width="80px" Text="Aceptar"></asp:button>&nbsp;
												<asp:button id="btnCancelar" runat="server" Width="80px" Text="Cancelar" CausesValidation="False"></asp:button><INPUT type="hidden" runat="server" size="1" NAME="hidTipoDocumento" id="hidTipoDocumento">
												<BR>
											</TD>
										</TR>
									</TABLE>
							...
							<tr>
								<td>
									<P align="center"><BR>
										&nbsp;
										<asp:RequiredFieldValidator id="valDescripcion" runat="server" CssClass="text" ErrorMessage="*" ControlToValidate="TxtTipoDocumento">Ingrese la descripción</asp:RequiredFieldValidator></P>
								</td>
							</tr>
							<tr>
								<td align="right"></td>
