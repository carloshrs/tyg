...
namespace ar.com.TiempoyGestion.FrontEnd.Intranet.Admin.Cuentas
{
    ...
    public partial class ListaCajaDetalles : Page
	{
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            GestorPrecios.CrearCajaDetalle(int.Parse(hdIdCaja.Value), int.Parse(cmbTipoIngreso.SelectedValue), cmbConcepto.SelectedItem.ToString(), float.Parse(txtMonto.Text));
