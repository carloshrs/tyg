<%@ Page Language="C#" AutoEventWireup="true" CodeFile="impresionenproceso.aspx.cs" Inherits="InformeInhibicion_listadopendientes" %>
...
<body onload="imprimir();">
    ...
    <div>
        ...
        <div style="width:100%; float:left; margin-bottom:20px; font-weight:bold; text-align:center; font-size:16px;">LISTADO DE INFORMES DE INHIBICIÓN - FORMULARIO TAZA</div>
        <div style="width:100%; float:left; border-bottom: solid 3px #000000;">
