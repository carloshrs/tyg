<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Contratos.ListaContratos" CodeFile="ListaContratos.aspx.cs" %>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td class="text" align="center" height="38">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<asp:dropdownlist id="cmbClientes" runat="server" Width="216px"></asp:dropdownlist>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											...
											<td><asp:datagrid id="dgridEncabezados" runat="server" Width="100%" Font-Size="8pt" PageSize="20"
													...
													<Columns>
														...
														<asp:TemplateColumn>
															...
															<ItemStyle HorizontalAlign="Center"></ItemStyle>
															<ItemTemplate>
																<asp:ImageButton id="Historico" runat="server" Width="16px" ImageUrl="..\Img\reloj.jpg" Height="16px"
																	CommandName="Historico" ToolTip="Ver Historial..."></asp:ImageButton>
															</ItemTemplate>
														</asp:TemplateColumn>
													</Columns>
