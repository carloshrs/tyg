<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Contratos.AltaPersonas" CodeFile="AltaPersonas.aspx.cs" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="text" width="100%" colSpan="4"><asp:dropdownlist id="cmbTipoPersona" runat="server" Width="528px"></asp:dropdownlist></TD>
				</TR>
				<TR>
						...
						<TABLE cellSpacing="0" cellPadding="0" width="535" border="0">
							...
							<TR>
								<TD class="text" width="100%" colSpan="3">
									<asp:DropDownList id="cmbTipo" runat="server" AutoPostBack="True" Width="528" onselectedindexchanged="Dropdownlist1_SelectedIndexChanged">
								...
								<TD class="text" width="100%">
									<asp:panel id="pnlPersona" runat="server">
										<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="title" width="535" bgColor="lightgrey" colSpan="4" height="10">&nbsp;&nbsp;Persona 
													Física</TD>
											</TR>
											<TR>
...
<asp:RequiredFieldValidator id=RequiredFieldValidator8 runat="server" ControlToValidate="RazonSocial" ErrorMessage="*"></asp:RequiredFieldValidator></TD></TR>
              <TR>
                <TD class=text width="100%">
...
<asp:TextBox id=Telefono runat="server" Width="160px"></asp:TextBox></TD></TR></TABLE></TD></TR>
              <TR>
                <TD colSpan=4>
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    <TR>
...
<asp:RequiredFieldValidator id=RequiredFieldValidator9 runat="server" ControlToValidate="Cuit" ErrorMessage="*"></asp:RequiredFieldValidator></TD></TR>
                    <TR>
                      <TD class=text width="50%">
<asp:TextBox id=Rubro runat="server" Width="320px"></asp:TextBox></TD>
                      <TD class=text width="10%">
<asp:TextBox id=Cuit runat="server" Width="160px"></asp:TextBox></TD></TR></TABLE></TD></TR>
              <TR>
                <TD colSpan=4>
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    <TR>
...
<asp:TextBox id=DptoEmpresa runat="server" Width="50px"></asp:TextBox></TD>
                      <TD class=text width="10%">
<asp:TextBox id=PisoEmpresa runat="server" Width="50px"></asp:TextBox></TD></TR></TABLE></TD></TR>
              <TR>
                <TD colSpan=4>
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    <TR>
                      <TD class=text width="50%">Barrio&nbsp; </TD>
                      <TD class=text width="10%">Código Postal&nbsp; </TD></TR>
                    <TR>
                      <TD class=text width="50%">
<asp:TextBox id=BarrioEmpresa runat="server" Width="320px"></asp:TextBox></TD>
                      <TD class=text width="10%">
<asp:TextBox id=CPEmpresa runat="server" Width="160px"></asp:TextBox></TD></TR></TABLE></TD></TR>
              <TR>
                <TD colSpan=4>
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    <TR>
...
<asp:dropdownlist id=cmbProvinciaEmpresas runat="server" Width="265px" AutoPostBack="True" onselectedindexchanged="cmbProvinciaEmpresas_SelectedIndexChanged"></asp:dropdownlist></TD>
                      <TD class=text width="50%">
<asp:dropdownlist id=cmbLocalidadEmpresas runat="server" Width="265px"></asp:dropdownlist></TD></TR></TABLE></TD></TR>
              <TR>
                <TD class=text 
