<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.verifDomLaboral.historialimpresiones" CodeFile="historialimpresiones.aspx.cs" %>
					...
					<td class="title" width="100%">
                        ...
                        <asp:Repeater ID="rpHistorial" runat="server">
                         ...
                         <div style="margin:16px;"><div style="float:left;"><img src="/Img/left.jpg" width="14" height="14" border="0" /></div>
                             <div style="width:700px; margin-top:5px;"><a href="impresionpendientes.aspx?estado=-1&idGrupo=<%#Eval("id")%>" class="link">
