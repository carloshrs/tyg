<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Mensajeria.pendientes" CodeFile="pendientes.aspx.cs" %>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td class="title" width="100%">
                        Listados de mensajerías pendientes&nbsp;
						<BR>
						<HR>
						<BR>
					</td>
						...
						<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<TD class="text" width="100%">
                                        ...
                                        <asp:datagrid id="dgMensajeriaPendientes" runat="server" Width="95%" 
										...
										AutoGenerateColumns="False" onprerender="dgMensajeriaPendientes_PreRender">
