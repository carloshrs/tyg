...
public partial class morosidad_listadopendientes : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        dlMorosidad.ItemDataBound +=
             new DataListItemEventHandler(this.Item_Bound);

        listarInformesMorosidad();
    }

    private void listarInformesMorosidad()
    {
    ...
    protected void Item_Bound(Object sender, DataListItemEventArgs e)
    {
            ...
            e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            int nroResto = int.Parse(((DataRowView)e.Item.DataItem).Row.ItemArray[15].ToString()) % 10;
