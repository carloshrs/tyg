<%@ Page language="c#" Inherits="ar.com.TiempoyGestion.FrontEnd.Intranet.Gravamenes.ProvidenciaCautelar.verInformeCalle" CodeFile="VerInformeCalle.aspx.cs" %>
...
width=175></td>
      ...
      Gravámenes - Providencia Cautelar</FONT>
						</FONT></P></TD>
				</TR>
				<tr>
					<td colSpan="2">
					...
					<td class="title" width="100%" colSpan="2">
						...
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
                              ...
                              color=gray>Datos Providencia Cautelar</FONT></TD>
																</TR>
															</TABLE>
														</TD>
													</TR>
			...
			</tr></TABLE><input id="idEncabezado" type="hidden" name="idEncabezado" runat="server">
